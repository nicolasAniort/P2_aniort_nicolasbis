...
def etl():
    ...
    #with open('./img_livre/'+ upc + '/'+ upc +'.jpg', 'xb') as img_file:
    #    img_bin = urlopen(image_url)
    #    img_file.write(urlopen(image_url))
...
#    etl("https://books.toscrape.com/catalogue/a-light-in-the-attic_1000/index.html")